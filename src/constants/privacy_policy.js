...
<p>
Users who visit the Website can access and read all content contained therein without the need to register data or personal information.
</p>
...
<ul>
    <li>For any illegal, defamatory, offensive, harmful, abusive, invasive of someone else's privacy, or objectionable reason or purpose;</li>
    <li>In a way that could harm or interrupt this Website or any of our services, or the peaceful use by other users;</li>
    <li>To transmit viruses or other malicious code that could damage or disrupt computer or telecommunication equipment or systems (hardware or software);</li>
    <li>In a way that could offend others or harm Banana Frog 3D, including sending or making available any illegal, false, misleading, threatening, malicious, abusive, defamatory, injurious, privacy-invasive, harmful content, or content that could negatively affect the image or activity of Banana Frog 3D;</li>
    <li>To promote any type of commercial activity, or to send or make available information or content that belongs to third parties and that you do not have the right to use, such as content protected by third-party copyright or content that contains third-party personal data.</li>
    <li>In general, the User should use the Website responsibly, prudently, and carefully, and should not disturb or damage its continuity or integrity.</li>
</ul>

<p>
Banana Frog 3D is not responsible for any direct, indirect, and/or negligent damages arising from the use of the information contained on this Website or the Website itself, as well as for harmful or disruptive conduct by the User.
</p>

<h1>Information and Content on this Website</h1>
...
<p>
The personal data of each user will be kept as long as the user's subscription and/or requests are active, with the aim of improving the services offered, and after their expiration, they will be depersonalized and not identifiable.
</p>

<p>
You are allowed to question the data and may request the deletion, rectification, updating, or completion of the same. These requests should be sent to bananafrog@bananafrog3d.com.
</p>


<h1>Use of Hyperlinks</h1>
...
<h1>Our Responsibility and Contacts<h1>
...
<h1>Automatically Collected Data</h1>
<p>
...
<h1>Access to Personal Data</h1>

<p>
To request clarifications about accessing personal data, or to clarify issues related to the privacy policy practiced at Banana Frog 3D, contact us via email bananafrog@bananafrog3d.com, or use the following postal address: Rua Leopoldo de Almeida, 30, 2750-035 Cascais
</p>
`